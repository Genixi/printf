...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2019/11/14 21:54:38 by equiana           #+#    #+#             */
/*   Updated: 2019/11/24 20:09:26 by equiana          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void    ft_putnbr_hho(unsigned char n, t_param *prm)
{
    ...
    nbr_str = NULL;
    size = ft_strlen(ft_itoa_base_hhu(n, 8, 0));
    ...
    if (width > size)
    {
        ...
        nbr_str = ft_itoa_base_hhu(n, 8, 0);
        if (head && hash)
            str[0] = '0';
    ...
    else
    {
        ...
        else
        {
            ...
            if (hash)
                ft_putchar('0');
            ft_putstr(ft_itoa_base_hhu(n, 8, 0));
        }
    }
}
